...
export default function Profile() {
    ...
    return (<>{profile && <div className='profile'>
        <div>
            <div id="pic">{profile.fname[0]}{profile.lname[0]}</div> {/* creating avatar */}
            ...
            <Link to='/profile/changepass'><button className="hbutton" disabled={check}><i className="bi bi-arrow-left-right">&nbsp;</i> &nbsp; Change Password</button></Link>
        </div>
        <Outlet />
    </div>}</>
